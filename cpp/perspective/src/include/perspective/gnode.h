...
typedef std::function<void(std::shared_ptr<t_data_table>, const std::vector<t_rlookup>&)> t_computed_column_def;
...
protected:
    void recompute_columns(std::shared_ptr<t_data_table> flattened, const std::vector<t_rlookup>& updated_ridxs);
