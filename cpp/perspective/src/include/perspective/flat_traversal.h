...
public:
    ...
    void fill_sort_elem(std::shared_ptr<const t_gstate> state,
    ...
    void add_row(std::shared_ptr<const t_gstate> state, const t_config& config,
        t_tscalar pkey);

    void update_row(std::shared_ptr<const t_gstate> state,
    ...
    t_uindex lower_bound_row_idx(std::shared_ptr<const t_gstate> state,
