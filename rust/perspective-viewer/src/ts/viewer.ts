...
import type * as perspective_viewer from "./ts-rs/ViewerConfigUpdate";
...
export interface IPerspectiveViewerElement {
     ...
     */
    restore(
        config: perspective_viewer.ViewerConfigUpdate | string | ArrayBuffer
    ): Promise<void>;
     ...
     * ```
     */
    save(): Promise<perspective_viewer.ViewerConfigUpdate>;
    save(format: "json"): Promise<perspective_viewer.ViewerConfigUpdate>;
    save(format: "arraybuffer"): Promise<ArrayBuffer>;
    save(format: "string"): Promise<string>;
    save(
        format?: "json" | "arraybuffer" | "string"
    ): Promise<perspective_viewer.ViewerConfigUpdate | string | ArrayBuffer>;
