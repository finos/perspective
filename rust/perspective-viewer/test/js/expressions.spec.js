        ...
        () => {
            test.capture("click on add column button opens the expression UI.", async page => {
                ...
                const monaco = await page.waitFor(async () => {
                    ...
                    return elem?.shadowRoot.querySelector("#monaco-container");
                });
            ...
            test.capture("blur closes the expression UI.", async page => {
                ...
                return await page.evaluate(async () => {
                    return document.querySelector("perspective-expression-editor")?.shadowRoot?.innerHTML || "MISSING";
                });
            });
            ...
            async function type_expression_test(page, expr) {
                ...
                await page.shadow_click("perspective-viewer", "#add-expression");
                await page.waitForSelector("perspective-expression-editor:not([initializing])");
                await page.shadow_type(expr, "perspective-expression-editor", "textarea");
                await page.waitForSelector("perspective-expression-editor:not([validating])");
                return await page.evaluate(async () => {
                    const elem = document.querySelector("perspective-expression-editor");
                    return elem.shadowRoot.querySelector("button").getAttribute("disabled") || "MISSING";
                });
            }
            ...
            test.capture("A type-invalid expression should disable the save button", async page => {
                return await type_expression_test(page, '"Sales" + "Category";');
            });

            test.capture("An expression with invalid input columns should disable the save button", async page => {
                return await type_expression_test(page, '"aaaa" + "Sales";');
            });

            test.capture("Should show both aliased and non-aliased expressions in columns", async page => {
                return await page.evaluate(async () => {
                    document.activeElement.blur();
                    const elem = document.querySelector("perspective-viewer");
                    await elem.toggleConfig(true);
                    ...
                    return elem.shadowRoot.querySelector("#expression-columns").innerHTML;
                });
            });

            test.capture("Should save an expression when the save button is clicked", async page => {
                await page.evaluate(async () => {
                    document.activeElement.blur();
                    const elem = document.querySelector("perspective-viewer");
                    await elem.toggleConfig(true);
            ...
            test.capture("Should overwrite a duplicate expression alias", async page => {
                await page.evaluate(async () => {
                    document.activeElement.blur();
                    const elem = document.querySelector("perspective-viewer");
                    await elem.toggleConfig(true);
            ...
            test.capture("Should overwrite a duplicate expression", async page => {
                await page.evaluate(async () => {
                    document.activeElement.blur();
                    const elem = document.querySelector("perspective-viewer");
                    await elem.toggleConfig(true);
            ...
            test.capture("Resetting the viewer should delete all expressions", async page => {
                await page.evaluate(async () => {
                    document.activeElement.blur();
                    const elem = document.querySelector("perspective-viewer");
                    await elem.toggleConfig(true);
            ...
            test.capture("Resetting the viewer when expression as in columns field, should delete all expressions", async page => {
                await page.evaluate(async () => {
                    document.activeElement.blur();
                    const elem = document.querySelector("perspective-viewer");
                    await elem.toggleConfig(true);
            ...
            test.capture("Resetting the viewer when expression as in row_pivots or other field, should delete all expressions", async page => {
                await page.evaluate(async () => {
                    document.activeElement.blur();
                    const elem = document.querySelector("perspective-viewer");
                    await elem.toggleConfig(true);
            ...
            test.capture("Expressions should persist when new views are created which don't use them", async page => {
                await page.evaluate(async () => {
                    document.activeElement.blur();
                    const elem = document.querySelector("perspective-viewer");
                    await elem.toggleConfig(true);
            ...
            test.capture("Expressions should persist when new views are created using them", async page => {
                await page.evaluate(async () => {
                    document.activeElement.blur();
                    const elem = document.querySelector("perspective-viewer");
                    await elem.toggleConfig(true);
            ...
            test.capture("Aggregates for expressions should apply", async page => {
                await page.evaluate(async () => {
                    document.activeElement.blur();
                    const elem = document.querySelector("perspective-viewer");
                    await elem.toggleConfig(true);
