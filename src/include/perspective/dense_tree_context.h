...
public:
    t_dtree_ctx(std::shared_ptr<const t_table> strands,
    ...
    std::shared_ptr<const t_table> get_strands() const;
    std::shared_ptr<const t_table> get_strand_deltas() const;
...
private:
    std::shared_ptr<const t_table> m_strands;
    std::shared_ptr<const t_table> m_strand_deltas;
