...
/***/ "../packages/perspective/dist/pkg/esm/perspective.cpp.js":
/*!***************************************************************!*\
  !*** ../packages/perspective/dist/pkg/esm/perspective.cpp.js ***!
  \***************************************************************/
...
/* harmony export */ });
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config */ "../packages/perspective/src/js/config/index.js");
/******************************************************************************
 *
...
/***/ "../packages/perspective/src/js/config/constants.js":
/*!**********************************************************!*\
  !*** ../packages/perspective/src/js/config/constants.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "../packages/perspective/src/js/data_accessor/index.js":
/*!*************************************************************!*\
  !*** ../packages/perspective/src/js/data_accessor/index.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils.js */ "../packages/perspective/src/js/utils.js");
/* harmony import */ var _config_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../config/index.js */ "../packages/perspective/src/js/config/index.js");
/******************************************************************************
 *
...
/***/ "../packages/perspective/src/js/emscripten.js":
/*!****************************************************!*\
  !*** ../packages/perspective/src/js/emscripten.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _config_constants_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config/constants.js */ "../packages/perspective/src/js/config/constants.js");
/* harmony import */ var _config_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./config/index.js */ "../packages/perspective/src/js/config/index.js");
/* harmony import */ var _data_accessor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./data_accessor */ "../packages/perspective/src/js/data_accessor/index.js");
/* harmony import */ var _emscripten_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./emscripten.js */ "../packages/perspective/src/js/emscripten.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils.js */ "../packages/perspective/src/js/utils.js");
/* harmony import */ var _api_server_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./api/server.js */ "../packages/perspective/src/js/api/server.js");
/* harmony import */ var _view_formatters__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view_formatters */ "../packages/perspective/src/js/view_formatters.js");
/******************************************************************************
 *
 * Copyright (c) 2017, the Perspective Authors.
 *
...
if (__webpack_require__.g.performance === undefined) {
    __webpack_require__.g.performance = {now: Date.now};
}
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(Module) {
    ...
    function view(table, sides, config, view_config, name) {
        ...
        if (this.is_unit_context) {
            this._View = __MODULE__.make_view_unit(
                table._Table,
                name,
                _config_constants_js__WEBPACK_IMPORTED_MODULE_0__.COLUMN_SEPARATOR_STRING,
                this.view_config,
                null
            );
        } else if (sides === 0) {
        ...
        if (override) {
            for (const key of Object.keys(schema)) {
                ...
                if (
                    ...
                    (0,_config_index_js__WEBPACK_IMPORTED_MODULE_1__.get_type_config)(this.overridden_types[colname]).type ===
                        schema[key]
                ) {
    ...
    view.prototype._column_names = function (skip = false, depth = 0) {
        return extract_vector_scalar(this._View.column_names(skip, depth)).map(
            (x) => x.join(_config_constants_js__WEBPACK_IMPORTED_MODULE_0__.COLUMN_SEPARATOR_STRING)
        );
    };
    ...
    view.prototype.column_paths = function () {
        return extract_vector_scalar(this._View.column_paths()).map((x) =>
            x.join(_config_constants_js__WEBPACK_IMPORTED_MODULE_0__.COLUMN_SEPARATOR_STRING)
        );
    };
            ...
            if (_config_constants_js__WEBPACK_IMPORTED_MODULE_0__.CONFIG_ALIASES[key]) {
                if (!config[_config_constants_js__WEBPACK_IMPORTED_MODULE_0__.CONFIG_ALIASES[key]]) {
                    if (!WARNED_KEYS.has(key)) {
                        console.warn(
                            `Deprecated: "${key}" config parameter, please use "${_config_constants_js__WEBPACK_IMPORTED_MODULE_0__.CONFIG_ALIASES[key]}" instead`
                        );
                        WARNED_KEYS.add(key);
                    }
...
/***/ "../node_modules/source-map-loader/index.js!../packages/perspective/src/js/perspective.worker.js":
/*!*******************************************************************************************************!*\
  !*** ../node_modules/source-map-loader/index.js!../packages/perspective/src/js/perspective.worker.js ***!
  \*******************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _finos_perspective_pkg_esm_perspective_cpp_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @finos/perspective/pkg/esm/perspective.cpp.js */ "../packages/perspective/dist/pkg/esm/perspective.cpp.js");
/* harmony import */ var _perspective_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./perspective.js */ "../packages/perspective/src/js/perspective.js");
/******************************************************************************
 *
 * Copyright (c) 2017, the Perspective Authors.
 *
...
if (__webpack_require__.g.document !== undefined && typeof WebAssembly !== "undefined") {
    _perspective_instance = __webpack_require__.g.perspective = (0,_perspective_js__WEBPACK_IMPORTED_MODULE_1__.default)(
        (0,_finos_perspective_pkg_esm_perspective_cpp_js__WEBPACK_IMPORTED_MODULE_0__.default)({
            wasmJSMethod: "native-wasm",
...
/***/ "../packages/perspective/src/js/utils.js":
/*!***********************************************!*\
  !*** ../packages/perspective/src/js/utils.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "../packages/perspective/src/js/view_formatters.js":
/*!*********************************************************!*\
  !*** ../packages/perspective/src/js/view_formatters.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const DEFAULT_CONFIG = __webpack_require__(/*! ./settings.js */ "../packages/perspective/src/js/config/settings.js").default;
...
module.exports.get_config = function get_config() {
    if (!__webpack_require__.g.__PERSPECTIVE_CONFIG__) {
        __webpack_require__.g.__PERSPECTIVE_CONFIG__ = mergeDeep(
            DEFAULT_CONFIG,
            {
    "types": {
        "float": {
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("../node_modules/source-map-loader/index.js!../packages/perspective/src/js/perspective.worker.js");
