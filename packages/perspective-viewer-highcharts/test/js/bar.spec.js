...
utils.with_server({}, () => {
        ...
        () => {
            ...
            describe("clicking on a bar", () => {
                describe("when no filters are present", () => {
                    test.capture(
                        "perspective dispatches perspective-click event with NO filters.",
                        async page => {
                            const viewer = await page.$("perspective-viewer");
                            await page.evaluate(
                                element =>
                ...
                describe("when a filter is present", () => {
                    test.capture(
                        "perspective dispatches perspective-click event with one filter.",
                        async page => {
                            const viewer = await page.$("perspective-viewer");
                    ...
                    test.capture(
                        "perspective dispatches perspective-click event with filters.",
                        async page => {
                            const viewer = await page.$("perspective-viewer");
                            await page.evaluate(element => {
                                element.setAttribute(
            ...
            describe("tooltip tests", () => {
                ...
                test.capture(
                    "dates on the x-axis display correctly.",
                    async page => {
                        const viewer = await page.$("perspective-viewer");
                ...
                test.capture(
                    "tooltip shows proper column labels based on hover target.",
                    async page => {
                        const viewer = await page.$("perspective-viewer");
                        await page.shadow_click(
                            "perspective-viewer",
                ...
                test.capture(
                    "tooltip shows proper column labels based on hover target, pt2.",
                    async page => {
                        const viewer = await page.$("perspective-viewer");
                        await page.shadow_click(
                            "perspective-viewer",
    ...
    describe.page(
        ...
        () => {
            test.capture(
                "render warning should not show under size limit.",
                async page => {
                    await page.waitForSelector(
                        "perspective-viewer:not([updating])"
                    );
            ...
            test.capture(
                ...
                async page => {
                    ...
                    await page.evaluate(
                        element =>
                            element.shadowRoot
                                .querySelector(".plugin_information__action")
                                .click(),
                        viewer
                    );
                    await page.waitForSelector(
            ...
            test.capture(
                ...
                async page => {
                    ...
                    await page.waitForSelector("perspective-viewer[updating]", {
                        timeout: 100000
                    });
                    await page.evaluate(element => {
