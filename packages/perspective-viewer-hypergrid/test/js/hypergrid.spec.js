...
utils.with_server({}, () => {
    describe.page(
        ...
        () => {
            test.capture(
                "perspective-click is fired when an empty dataset is loaded first",
                async page => {
        ...
        () => {
            describe("clicking on a cell in the grid", () => {
                describe("when no filters are present", () => {
                    test.capture(
                        "perspective dispatches perspective-click event with correct properties.",
                        async page => {
                            await page.waitFor(100);
                ...
                describe("when a filter is present", () => {
                    ...
                    test.capture(
                        "perspective-click event with column-pivots clicking on the row header.",
                        async page => {
                            await page.waitFor(100);
                            const viewer = await page.$("perspective-viewer");
                            page.evaluate(element => {
