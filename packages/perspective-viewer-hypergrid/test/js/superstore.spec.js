    ...
    describe.page(
        ...
        () => {
            ...
            describe("expand/collapse", () => {
                test.capture(
                    "should not be able to expand past number of row pivots",
                    async page => {
                ...
                test.capture(
                    "collapses to depth smaller than viewport",
                    async page => {
                        const viewer = await page.$("perspective-viewer");
                        await page.evaluate(
                            element =>
            ...
            describe("sort indicators", () => {
                test.capture("shows a sort indicator", async page => {
                    ...
                    await page.evaluate(
                        element =>
                            element.setAttribute("sort", '[["Row ID", "asc"]]'),
                        viewer
                    );
                });
                ...
                test.capture(
                    "shows a sort indicator on column split",
                    async page => {
                        const viewer = await page.$("perspective-viewer");
                        await page.shadow_click(
                            "perspective-viewer",
            ...
            describe("memoized column meta", () => {
                test.capture(
                    "should reinterpret metadata when only row pivots are changed",
                    async page => {
                        const viewer = await page.$("perspective-viewer");
                        await page.shadow_click(
                            "perspective-viewer",
            ...
            test.capture(
                "resets viewable area when the logical size expands.",
                async page => {
                    const viewer = await page.$("perspective-viewer");
                    await page.shadow_click(
                        "perspective-viewer",
            ...
            test.capture(
                "resets viewable area when the physical size expands.",
                async page => {
                    const viewer = await page.$("perspective-viewer");
                    await page.shadow_click(
                        "perspective-viewer",
                    ...
                    await page.evaluate(
                        element => element.setAttribute("row-pivots", "[]"),
                        viewer
                    );
                    await page.shadow_click(
                        "perspective-viewer",
