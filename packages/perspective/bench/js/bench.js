...
const UNPKG_URLS = multi_template`https://unpkg.com/@finos/perspective@${UNPKG_VERSIONS}/build/perspective.js`;

const OLD_FORMAT_UNPKG_VERSIONS = ["0.2.0-beta.3"];
const OLD_FORMAT_UNPKG_URLS = multi_template`https://unpkg.com/@finos/perspective-examples@${OLD_FORMAT_UNPKG_VERSIONS}/build/perspective.js`;
