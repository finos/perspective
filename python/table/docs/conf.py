...
# -*- coding: utf-8 -*-
#
# perspective-python.table documentation build configuration file, created by
...
project = 'perspective-python.table'
...
htmlhelp_basename = 'perspective.tabledoc'
...
latex_documents = [
    (master_doc, 'perspective.table.tex', 'perspective.table Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'perspective.table', 'perspective.table Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'perspective.table', 'perspective.table Documentation',
     author, 'perspective.table', 'One line description of project.',
     'Miscellaneous'),
]
