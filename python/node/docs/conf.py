...
# -*- coding: utf-8 -*-
#
# perspective-python.node documentation build configuration file, created by
...
project = 'perspective-python.node'
...
htmlhelp_basename = 'perspective.nodedoc'
...
latex_documents = [
    (master_doc, 'perspective.node.tex', 'perspective.node Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'perspective.node', 'perspective.node Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'perspective.node', 'perspective.node Documentation',
     author, 'perspective.node', 'One line description of project.',
     'Miscellaneous'),
]
