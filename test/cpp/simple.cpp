...
template <>
const perspective::t_tscalar test_traits<std::string>::zero;
template <>
const perspective::t_tscalar test_traits<std::string>::v1;
template <>
const perspective::t_tscalar test_traits<std::string>::v2;
